...
<form action="/studentUpdateDetail}"  method="post">
    ...
    <div id="upper">
        ...
        <div id="input">
            <div id="name">
                <label>姓名:&nbsp;&nbsp;&nbsp;</label><input font style="color:black" class="input" type="text" name="studentName" placeholder="如张三" value="<%=studentName%>"/>
            </div>
            <div id="ID">
                <label>学号:&nbsp;&nbsp;&nbsp;</label><input font style="color:black" class="input" type="text" name="studentID"placeholder="如U201514151" value="<%=studentID%>"/>
            </div>
        </div>
        <div id="btn">
